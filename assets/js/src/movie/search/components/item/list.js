...
const undefinedElement = () => {
    return `<div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" id="highlight-banner">
                <div class="card-body d-flex justify-content-between flex-column ps-xl-18">
                        <h1 class="fw-bold text-white ms-n1 text-center">Data Not Found</h1>
                </div>
            </div>`;
};

export { listElement, undefinedElement };
